        ...
        <div class="modal-content">
			...
			<form method="POST" action="add_blog.php">
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="dish_id" readonly value="<?php echo  strtotime(date('Y-m-d H:i:s')); ?>"/>
					</div>
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" required name="dish_price">
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" required readonly name="dish_date" value="<?php echo date('M/d/Y'); ?>">
					</div>
				</div>
