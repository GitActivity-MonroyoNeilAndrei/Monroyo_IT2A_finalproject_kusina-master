        ...
        <div class="modal-content">
			...
			<form method="POST" action="edit_blog.php">
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;">Dish ID:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="dish_id" value="<?php echo $rows->id; ?>" readonly>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="dish_name" value="<?php echo $rows->title; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="dish_price" value="<?php echo $rows->author; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
